...
test.only('<BlogForm /> calls onSubmit', async () => {
    ...
    await user.type(urlInput, 'http://blog.cleancoder.com/uncle-bob/2017/05/05/TestDefinitions.htmll')
    ...
    expect(addBlog.mock.calls[0][0].url).toBe('http://blog.cleancoder.com/uncle-bob/2017/05/05/TestDefinitions.htmll')
})